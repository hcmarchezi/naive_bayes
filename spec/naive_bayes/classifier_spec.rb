...
describe NaiveBayes::Classifier do
    context 'categories' do
        ...
        it 'should not be repeated' do
            classifier = NaiveBayes::Classifier.new
            classifier.add_category(name: :bad_news, training_set: [])
            expect{ classifier.add_category(name: :bad_news, training_set: []) }.to raise_error(NaiveBayes::Error::CategoryNameAlreadyExists)
        end
        it 'should not be nil' do
            classifier = NaiveBayes::Classifier.new
            expect{ classifier.add_category(name: nil, training_set: []) }.to raise_error(NaiveBayes::Error::InvalidCategoryName)
        end
    end
